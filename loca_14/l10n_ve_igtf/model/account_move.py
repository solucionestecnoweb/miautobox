...
class AccountMove(models.Model):
    ...
    def registro_movimiento_linea_anticipo(self,id_movv,total_monto,anti_nombre,id_payment,acum_anti):
        ...
        if tipo_persona=="in_invoice" or tipo_persona=="in_receipt":
            cuenta_a=cuenta_anti_proveedor
            cuenta_b=cuenta_pagar
        if tipo_persona=="out_invoice" or tipo_persona=="out_receipt":
...
#************ funcionpara que funcione en lanta *************
    def concilio_saldo_pendiente_anti(self,id_move_conci,id_payment,cont2,acum_anti):
        ...
        if self.amount_residual>0:
            ...
            if tipo_empresa=="in_invoice" or tipo_empresa=="out_refund" or tipo_empresa=="in_receipt":#aqui si la empresa es un proveedor
                type_internal="payable"
            if tipo_empresa=="out_invoice" or tipo_empresa=="in_refund" or tipo_empresa=="out_receipt":# aqui si la empresa es un cliente
