    ...
    def mapping_all_invoices(self, from_request):
        ...
        for items in get_invoices:
            invoice = {
                ...
                'journal_id': list(self.extract_details(items.journal_id)),
                'company_id': list(self.extract_details(items.company_id)),
                'company_currency_id': list(self.extract_details(items.company_currency_id)),
                'currency_id': list(self.extract_details(items.currency_id)),
                'partner': self.extract_partner(items.partner_id),
                'commercial_partner_id': list(self.extract_details(items.commercial_partner_id)),
